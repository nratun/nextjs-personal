...
export default function Home() {
  return (
    <body>
      ...
      <ul className="sidebar" aria-label="Media">
          <li>v</li>
          <li>
            <a className="block hover:text-slate-200" href="https://github.com/nratun" target="_blank" rel="noreferrer">
              {/* Consider adding span tag w/ text of each icon */}
          ...
          <li>
            <a className="block hover:text-slate-200" href="https://www.linkedin.com/in/rana-tuncer-304956281" target="_blank" rel="noreferrer">
              {/* Consider adding span tag w/ text of each icon */}
      ...
      <main className="mainEdges">
        <section className="sectionEdges">
          <h1 className="title">Rana Tuncer</h1>
          <h2>Student at University of Delaware</h2>
